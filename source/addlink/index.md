...
---
注意事项:
欢迎来到清羽飞扬！如果您想申请友链，请点击查看友链要求，若符合要求请以下面代码块中的格式化，发送您网站相关内容，感谢您的赏识！
```
友链要求：
更新记录
2024-11-18规则更新：
...
可接受的免费域名：如 github.io、gitee.io、eu.org、clouddns、cf pages、cf worker 等，这些免费域名只要内容合规，都没有问题。
暂不接受的免费域名：如 vercel，由于SNI阻断的原因暂不考虑使用，us.kg由于稳定性原因，暂时不接受，观望一段时间。
需要审核的小众二级分发域名：如果您的域名来自不知名的小众二级分发服务，可能存在劫持或安全风险，这类域名不接受。
付费域名：常见的顶级域名如 .cn、.com、.com.cn、.js.cn、.fun、.top 等，都完全符合要求。
文章数量：为了确保友链的质量，建议申请友链时贵站的文章数量在10篇以上。
